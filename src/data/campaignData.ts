...
/*  
  {
    ...
    wish: "ขอให้นีย่ามีสุขภาพร่างกายแข็งแรง ทานข้าวเยอะๆ พักผ่อนให้เพียงพอ ไม่เจ็บไม่ป่วย ร่าเริงสดใสตลอดทั้งปี 💖",
  ...
  },
  {
    id: "tb-3",
    author: "P'Korn BKK",
    wish: "ขอให้ความพยายามและการซ้อมอย่างหนักของนีย่าส่งผลให้ยืนอยู่แถวหน้าบนเวทีใหญ่ เป็นกำลังใจให้เสมอ!",
  ...
  },
  {
    ...
    wish: "ขอให้ทางช้างเผือกนำพาคำอธิษฐานของพวกเราทุกคนให้กลายเป็นจริง พานีย่าไปสู่ดาวดวงที่เจิดจรัสที่สุด!",
  ...
  {
    id: "tb-5",
    author: "แมวน้อยของนีย่า",
    wish: "ไม่ว่าจะเกิดอะไรขึ้น แฟนคลับจะคอยอยู่เคียงข้างและซัพพอร์ตนีย่าตลอดไป มีความสุขในทุกๆ วันนะคนเก่ง 🌸",
  ...
  },
  {
    ...
    wish: "ขอให้ยอดโดเนททะลุเป้า 500,000 บาท ขึ้นป้ายสยามและบิลบอร์ดทั่วกรุงอย่างงดงาม นีย่าไฟต์โตะ! 🚀",
