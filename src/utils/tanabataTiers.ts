...
export const TANABATA_TIERS: TanabataTierInfo[] = [
    ...
    },
    {
        ...
        nameEn: 'Blossom Whisper Supporter',
        minDonation: 200,
        badge: '🌸 Blossom Whisper',
        icon: '🌸',
    ...
    {
        index: 3,
        name: 'Sparkle Blessing',
        nameEn: 'Sparkle Blessing Supporter',
        minDonation: 100,
        badge: '✨ Sparkle Blessing',
        icon: '✨',
        colorName: 'Sparkle Blessing',
        description: 'โดเนท 100 บาท • ละอองประกาย แสงวิบวับเล็กๆ ที่มารวมกันแล้วสดใสมาก'
    },
    {
        index: 4,
        name: 'Little Stardust',
        nameEn: 'Little Stardust Supporter',
        minDonation: 50,
        badge: '🌟 Little Stardust',
        icon: '🌟',
        colorName: 'Little Stardust Pastel',
